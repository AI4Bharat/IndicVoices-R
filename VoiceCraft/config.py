...
def MyParser():
    ...
    # experimental
    parser.add_argument('--use_prompt', action='store_true', help='whether to use prompts')
    parser.add_argument('--use_prompt_prob', type=float, default=.5, help='probability of using prompts')
